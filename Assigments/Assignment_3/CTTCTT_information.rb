  ...
  embl.each do |key, info|
    ...
    info.features.each do |feature|
      ...
      next if exon_seq.nil?
        ...
        if location.strand == -1
          #When the strand is negative we can search in the complement strand the cttctt repeats or we can search for the complement of cttctt ( aagaag) in the positive strand 
